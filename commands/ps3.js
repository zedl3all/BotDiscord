module.exports = {
    name:'ps3',
    description:"นี่คือคำสั่ง เล่นเสียงโบ",
    async execute(message,args){
        ...
        message.channel.send('ขณะนี้กำลังเล่นเสียงใครบางคนพร้อมเพลง:thinking:').then(setTimeout(() => {  message.channel.bulkDelete(2) }, 5000));
        const dispatcher = connection.play('C:/Users/SA090164/Desktop/DB/sound/Bo.wav',{seek: 0,volume: 1});
